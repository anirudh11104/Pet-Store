    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route path="/Rabbit" element={<Rabbit addToCart={addToCart}/>} />
                <Route path="/Guinea" element={<Guinea addToCart={addToCart}/>} />
                <Route path="/Chinchilla" element={<Chinchilla addToCart={addToCart}/>} />
                <Route path="/Hamster" element={<Hamster addToCart={addToCart}/>} />
            </Routes>
        </div>
    );
}
